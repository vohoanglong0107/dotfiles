...
local path_to_java_debug = mason_registry.get_package("java-debug-adapter"):get_install_path()
...
local path_to_java_test = mason_registry.get_package("java-test"):get_install_path()
