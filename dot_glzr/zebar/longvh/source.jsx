...
function App() {
  ...
  function getNetworkIcon(networkOutput) {
    switch (networkOutput.defaultInterface?.type) {
      ...
      case "wifi":
        if (networkOutput.defaultInterface?.signalStrength >= 80) {
          return <i className="nf nf-md-wifi_strength_4"></i>;
        } else if (networkOutput.defaultInterface?.signalStrength >= 65) {
          return <i className="nf nf-md-wifi_strength_3"></i>;
        } else if (networkOutput.defaultInterface?.signalStrength >= 40) {
          return <i className="nf nf-md-wifi_strength_2"></i>;
        } else if (networkOutput.defaultInterface?.signalStrength >= 25) {
  ...
  function getAudioIcon(audioOutput) {
    if (audioOutput.defaultPlaybackDevice?.volume >= 80) {
      return <i className="nf nf-md-volume_high"></i>;
    } else if (audioOutput.defaultPlaybackDevice?.volume >= 40) {
      return <i className="nf nf-md-volume_medium"></i>;
    } else if (audioOutput.defaultPlaybackDevice?.volume) {
    ...
    <div className="app">
      ...
      <div className="right">
        {output.glazewm && (
          <div className="modes">
            {output.glazewm.isPaused && (
              ...
              >
                <i className="nf nf-md-pause_octagon"></i>
              </button>
            )}
        ...
        <div className="modules">
          ...
          {output.audio && (
            <div className="audio">{getAudioIcon(output.audio)}</div>
          )}
